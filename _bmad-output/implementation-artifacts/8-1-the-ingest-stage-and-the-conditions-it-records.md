...
**The ten conditions. Nine bullets below quote a field description and a tenth carries the framing; the third and fifth feed one condition between them, and the two absent cases have no bullet because no schema can describe an absent artifact. Seven of the ten were known at approval; the disposition citations and the two evaluator-configuration rules were found in this story's code review, both in field descriptions that had been sitting there through five spec rounds**
...
**The consumers this product must satisfy, and the seven that do not exist yet**
