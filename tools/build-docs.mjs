...
function generateLlmsTxt(outputDir) {
	...
	const content = [
		...
		`- **[The Full Walkthrough](${siteUrl}/how-to/author-behavioral-contracts/)** - Author a contract, run all four commands, and read a scored run`,
		'',
		'## Core Concepts',
		'',
		`- **[How It Works](${siteUrl}/explanation/behavioral-evaluation-contracts/)** - The twin run, what a contract declares, and why compile rejects`,
