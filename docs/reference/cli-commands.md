...
- **Enumerations**: `FAILURE_CODES`, `RUNTIME_FAULT_CODES`, `FORBIDDEN_TARGET_REASONS`, `VERDICTS`, `EVALUATOR_RECOMMENDATIONS`, `INTERCHANGE_ARTIFACT_KEYS`, `QUALIFICATION_FAILURES`, `SEVERITY_LEVELS`, `DOMINANCE_RELATIONS`, `OUTCOME_STATES`, `DISCIPLINE_RULES`
